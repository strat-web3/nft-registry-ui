...
export default function Update() {
  ...
  const [info, setInfo] = useState<string>('Ce NFT est considéré comme perdu.')
  ...
  return (
    <>
      ...
      <main>
        <HeadingComponent as="h2">Actualiser le statut d&apos;un NFT</HeadingComponent>
        <br />
        <FormControl>
          ...
          <br />
          <FormLabel>Empreinte numérique du fichier associé au NFT</FormLabel>
          <Input value={sourceFileHash} onChange={(e) => setSourceFileHash(e.target.value)} placeholder={sourceFileHash} />
          <FormHelperText>SHA384 du fichier associé.</FormHelperText>
          <br />
        ...
        <Button
          ...
          isLoading={isLoading}
          loadingText="Actualisation en cours..."
